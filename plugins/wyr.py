...
A plugin that uses the RRRather.com API to return random
...
Special Thanks:
    - http://www.rrrather.com/ for adding extra features to their API to make
...
def wyr(bot):
    ...
    for _ in range(TRIES):
        ...
        return "Unable to find a would you rather question"
