...
bad_station_msg = (
    ...
    "See http://weather.rap.ucar.edu/surface/stations.txt for a list."
)
...
def metar(text):
    """
    [ICAO station code] - returns the metars information for the specified
    station. A list of station codes can be found here:
...
def taf(text):
    """
    [ICAO station code] - returns the taf information for the specified
    station. A list of station codes can be found here:
    http://weather.rap.ucar.edu/surface/stations.txt
    """
