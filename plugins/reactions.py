...
def deal_with_it(text, message):
    """
    <nick> - Tell <nick> in the channel to deal with it. Code located in
    reactions.py
    """
...
def face_palm(text, message):
    """
    <nick> - Expresses your frustration with <Nick>. Code located in
    reactions.py
    """
...
def head_desk(text, message):
    """
    <nick> - Hit your head against the desk becausae of <nick>.
    Code located in reactions.py
    """
    idiot = text.strip()
    message(
        "{} {}".format(
...
def my_fetish(text, message):
    """
    <nick> - Did some one just mention what your fetish was? Let <nick>
    know! Code located in reactions.py
    """
