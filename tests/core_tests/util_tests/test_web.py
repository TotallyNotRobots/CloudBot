...
def test_paste(mock_requests):
    mock_requests.add(
        mock_requests.POST, 'https://hastebin.com/documents', json={
            'key': 'foobar'
        }
    )
    from cloudbot.util import web
    assert web.paste('test data', service='hastebin') == 'https://hastebin.com/foobar.txt'
...
def test_paste_error(mock_requests):
    ...
    mock_requests.replace(
        mock_requests.POST, 'https://hastebin.com/documents',
        json={
            'message': 'Error'
        },
        status=201
...
def test_shorten(mock_requests):
    ...
    assert web.shorten('https://example.com', service='goo.gl') == 'https://goo.gl/foobar'
    ...
    mock_requests.replace(
        ...
        'http://git.io',
        headers={
            'Location': 'http://git.io/foobar123'
        },
        status=requests.codes.created
    )
    assert web.shorten('https://example.com', service='git.io') == 'http://git.io/foobar123'
...
def test_try_shorten(mock_requests):
    ...
    from cloudbot.util import web
    assert web.try_shorten('https://example.com', service='is.gd') == 'https://is.gd/foobar'
    ...
    assert web.try_shorten('https://example.com', service='is.gd') == 'https://example.com'
